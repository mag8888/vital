...
export const SIAM_JSON_ENTRIES = [
    {
        ...
        full_description: 'Флагманский продукт бренда. Мощная смесь масел холодного отжима, богатая антиоксидантами. Питает, восстанавливает эластичность, защищает от старения. Подходит для всех типов кожи.',
        price: 'По запросу',
        sku: 'FS1003-24',
        volume: '24 мл',
        ingredients: 'Oryza Sativa Rice Bran Oil, Vitis Vinifera Grape Seed Oil, Prunus Amygdalus Dulcis Sweet Almond Oil, Moringa Oleifera Moringa Seed Oil, Argania Spinosa Argan Kernel Oil, Rosmarinus Officinalis Rosemary Leaf Oil, Cymbopogon Citratus Lemongrass Oil, Tocopherol',
    },
    {
        title: 'Масло для лица Rudis Oleum (Men\'s Formula)',
        short_description: 'Мужская версия легендарного масла для лица.',
        full_description: 'Специально разработанная формула для мужской кожи. Успокаивает после бритья, питает, не оставляя жирного блеска. Имеет более терпкий аромат гвоздики и мяты.',
        price: 'По запросу',
        sku: 'FS1002-24',
        volume: '24 мл',
        ingredients: 'Vitis Vinifera Grape Seed Oil, Prunus Amygdalus Dulcis Sweet Almond Oil, Simmondsia Chinensis Jojoba Seed Oil, Moringa Oleifera Moringa Seed Oil, Cymbopogon Citratus Lemongrass Oil, Rosmarinus Officinalis Rosemary Leaf Oil, Eugenia Caryophyllus Clove Leaf Oil, Mentha Piperita Peppermint Oil',
    },
    {
        ...
        full_description: 'Обогащено маслом Таману для мощной регенерации. Идеально для поврежденной кожи, склонной к воспалениям или шрамам.',
        price: 'По запросу',
        sku: 'FS1006-24',
        volume: '24 мл',
        ingredients: 'Calophyllum Inophyllum Tamanu Seed Oil, Moringa Oleifera Moringa Seed Oil, Argania Spinosa Argan Kernel Oil, Pelargonium Graveolens Geranium Flower Oil, Citrus Aurantium Bergamia Bergamot Fruit Oil',
    },
    {
        title: 'Масло для лица \'Rosehip & Jojoba\' (Шиповник и Жожоба)',
        short_description: 'Антивозрастное масло для выравнивания тона.',
        full_description: 'Классическое сочетание для зрелой кожи. Масло шиповника стимулирует регенерацию, жожоба увлажняет. Помогает бороться с пигментацией и мелкими морщинами.',
        price: 'По запросу',
        sku: 'FO0001-30',
        volume: '30 мл',
        ingredients: 'Simmondsia Chinensis Jojoba Seed Oil, Rosa Canina Rosehip Fruit Oil, Argania Spinosa Argan Kernel Oil, Tocopherol',
    },
    {
        ...
        full_description: 'Масло черного тмина обладает сильным антибактериальным действием, а клюква насыщает витаминами. Балансирует жирную кожу.',
        price: 'По запросу',
        sku: 'FO0002-30',
        volume: '30 мл',
        ingredients: 'Simmondsia Chinenis Jojoba Seed Oil, Vaccinium Macrocarpon Cranberry Seed Oil, Nigella Sativa Black Cumin Seed Oil, Tocopherol',
    },
    {
        ...
        sku: 'FO0003-30',
        volume: '30 мл',
        ingredients: 'Simmondsia Chinenis Jojoba Seed Oil, Punica Granatum Pomegranate Seed Oil, Passiflora Edulis Passionfruit Seed Oil, Psidium Guajava Guava Seed Oil, Tocopherol',
    },
    {
        ...
        full_description: 'Масло семян малины обладает природным SPF-фактором. Легкая текстура, быстро впитывается, идеально на лето.',
        price: 'По запросу',
        sku: 'FO0004-30',
        volume: '30 мл',
        ingredients: 'Simmondsia Chinenis Jojoba Seed Oil, Rubus Idaeus Raspberry Seed Oil, Passiflora Edulis Passionfruit Seed Oil, Tocopherol',
    },
    {
        title: 'Масло Моринги (Moringa Oil) 100%',
        short_description: 'Чистое масло моринги холодного отжима.',
        full_description: "Универсальное 'чудо-масло'. Глубоко увлажняет, обладает антисептическими свойствами. Подходит для лица, тела и волос.",
        price: 'По запросу',
        sku: 'SI0044-45',
        volume: '45 мл',
    ...
    },
    {
        ...
        full_description: 'Традиционное средство полинезийцев. Ускоряет заживление ран, ожогов, акне, рубцов. Имеет специфический ореховый запах.',
        price: 'По запросу',
        sku: 'SI0045-45',
        volume: '45 мл',
    ...
    },
    {
        ...
        full_description: 'Растворяет макияж и загрязнения. Чайное дерево борется с воспалениями, шиповник питает. Смывается водой.',
        price: 'По запросу',
        sku: 'FC0001-45',
        volume: '45 мл',
    ...
    },
    {
        ...
        sku: 'FC0003-45',
        volume: '45 мл',
        ingredients: 'Prunus Amygdalus Dulcis Sweet Almond Oil, Ricinus Communis Castor Seed Oil, Nigella Sativa Black Caraway Seed Oil, Melissa Officinalis Lemon Balm Leaf Oil',
    },
    {
        ...
        sku: 'FC0020-90',
        volume: '90 мл',
        ingredients: 'Aloe Barbadensis Aloe Vera Leaf Juice, Rosa Eglanteria Rose Hip Seed Oil, Coco-Glucoside, Cucumis Sativus Cucumber Fruit Extract, Pelargonium Graveolens Geranium Flower Oil',
    },
    {
        ...
        sku: 'FC0021-90',
        volume: '90 мл',
        ingredients: 'Aloe Barbadensis Aloe Vera Leaf Juice, Rosa Eglanteria Rose Hip Seed Oil, Zingiber Cassumunar Plai Root Oil, Cymbopogon Citratus Lemongrass Oil',
    },
    {
        title: 'Розовая цветочная вода (Rose Water)',
        short_description: 'Натуральный гидролат дамасской розы.',
        full_description: 'Увлажняет, тонизирует, восстанавливает pH-баланс кожи. Идеально для использования перед нанесением масла.',
        price: 'По запросу',
        sku: 'FS0016-50',
        volume: '50 мл',
    ...
    },
    {
        ...
        sku: 'FB0002-20',
        volume: '20 г',
        ingredients: 'Sugar, Honey, Cocos Nucifera Coconut Oil, Simmondsia Chinensis Jojoba Seed Oil, Prunus Amygdalus Dulcis Sweet Almond Oil',
    },
    {
    ...
    },
    {
        ...
        sku: 'GOS0003-20',
        volume: '20 мл',
        ingredients: 'Argania Spinosa Argan Kernel Oil, Moringa Oleifera Moringa Seed Oil, Rosa Canina Rosehip Fruit Oil, Rosmarinus Officinalis Rosemary Leaf Oil',
    },
    {
        ...
        ingredients: 'Aloe Barbadensis Aloe Vera Leaf juice, Decyl Glucoside, Zingiber Cassumunar Plai Root Oil, Cymbopogon Citratus Lemongrass Oil',
    },
    {
        ...
        sku: 'SP0021-470',
        volume: '470 мл (доступны 100/230 мл)',
        ingredients: 'Aloe Barbadensis Aloe Vera Leaf juice, Lavandula Angustifolia Lavender Oil, Cananga Odorata Ylang Ylang Flower Oil',
    },
    {
        ...
        sku: 'SP0022-470',
        volume: '470 мл (доступны 100/230 мл)',
        ingredients: 'Aloe Barbadensis Aloe Vera Leaf juice, Mentha Piperita Peppermint Oil, Rosmarinus Officinalis Rosemary Leaf Oil',
    },
    {
        ...
        sku: 'BL1001-90',
        volume: '90 мл / 220 мл',
        ingredients: 'Aloe Barbadensis Aloe Vera Leaf Juice, Prunus Amygdalus Dulcis Sweet Almond Oil, Lavandula Angustifolia Lavender Flower Extract',
    },
    {
    ...
    },
    {
        ...
        sku: 'SH0001-470',
        volume: '470 мл (доступны 100/230 мл)',
        ingredients: 'Aloe Barbadensis Aloe Vera Leaf juice, Hydrolyzed Wheat Protein, Zingiber Cassumunar Plai Root Oil, Cymbopogon Flexuosus Lemongrass Oil',
    },
    {
    ...
    },
    {
        ...
        ingredients: 'Aloe Barbadensis Aloe Vera Leaf juice, Cetyl Alcohol, Macadamia Integrifolia Seed Oil, Zingiber Cassumunar Plai Root Oil',
    },
    {
        ...
        ingredients: 'Cocos Nucifera Coconut Oil, Zingiber Officinale Ginger Root Oil, Melaleuca Alternifolia Tea Tree Leaf Oil',
    },
    {
        ...
        sku: 'SP0014-50',
        volume: '50 г / 100 г',
        ingredients: 'Cocos Nucifera L. Coconut Oil, Cymbopogon Flexuosus Lemongrass Oil, Cedrus Atlantica Cedarwood Bark Oil',
    },
    {
    ...
    },
    {
        ...
        sku: 'BA0002-25',
        volume: '25 г',
        ingredients: 'Butyrospermum Parkii Shea Butter, Eugenia Caryophyllus Clove Leaf Oil, Mentha Piperita Peppermint Oil, Cinnamomum Zeylanicum Cinnamon Bark Extract',
    },
    {
    ...
    },
    {
        ...
        sku: 'PE1001-12',
        volume: '12 г',
        ingredients: 'Butyrospermum Parkii Shea Butter, Beeswax, Lavandula Angustifolia Lavender Oil, Citrus Aurantium Bergamia Bergamot Fruit Oil',
    },
    {
