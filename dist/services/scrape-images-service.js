 ...
 */
export async function scrapeShopPage(page = 1) {
    ...
    try {
        ...
        const products = [];
        const foundUrls = new Set(); // Для избежания дубликатов
 ...
 */
export async function extractImageFromProductPage(productUrl) {
    try {
 ...
 */
export async function downloadAndUploadImage(imageUrl, productId, productTitle) {
    try {
 ...
 */
export async function findProductInDB(title, slug) {
