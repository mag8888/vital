/**
 * Скрипт для сбора и обновления ВСЕХ фотографий продуктов
 * с сайта Siam Botanicals (https://siambotanicals.com/shop/)
 * 
 * Этот скрипт обновит изображения для всех товаров, включая те, у которых уже есть фото.
 * Это позволит получить более качественные изображения, загружая их со страниц товаров.
 */
 ...
 */
async function main() {
  console.log('🚀 Начало сбора и обновления ВСЕХ фотографий продуктов\n');
  console.log('📝 Этот скрипт обновит изображения для всех товаров, включая те, у которых уже есть фото\n');
